...
## Quando impostato su 'True', le didascalie del menu saranno dette dal
## narratore. Quando falso, le didascalie saranno mostrate come pulsanti
## inattivi.
...
screen navigation():
    ...
    vbox:
        ...
        if _in_replay:
            ...
            textbutton _("Menu Iniziale") action MainMenu()
    ...
    use game_menu(_("Opzioni"), scroll="viewport"):
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "radio"
                    label _("Lato Riavvolgimento")
                    textbutton _("Disattiva") action Preference("rollback side", "disable")
...
screen keyboard_help():
    ...
    hbox:
        label "V"
        text _("Attiva l'{a=https://www.renpy.org/l/voicing}Assistente Vocale per non vedenti{/a}.")
...
screen nvl(dialogue, items=None):
    ...
    window:
        ...
        ## config.narrator_menu è impostato a True, come lo è sopra.
        for i in items:
